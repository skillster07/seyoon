...
(function () {
    ...
    var phT = src.layers.addText("REPLACE\r아기 클로즈업 실사 · 4K · 14초 이상\r얼굴을 화면 중앙에");
    ...
    // ---------- PRE_SPARKS (light spreading out of the window: "세상을 바꿉니다") ----------
    ...
    if (bfn) {
        ...
        setP(bfn, ["Brightness", "밝기"], 5, -160, "BOKEH Fractal Brightness=-160");
    ...
    // warm halo behind the window (the approved v02 "따뜻한 후광")
    ...
    textLayer("작은 시작이", fontKR, 56, 10, [176, 486], ivory, 0, 1.2, 14);
    var t2 = textLayer("세상을 바꿉니다", fontKRB, 90, -10, [170, 596], ivory, 0.5, 1.4, 14);
